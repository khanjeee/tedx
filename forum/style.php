...
// happen to have a current session it will output nothing. We will also cache_phpbb the
...
if ($id)
{
	...
	require($phpbb_root_path . 'includes/cache_phpbb.' . $phpEx);
	require($phpbb_root_path . 'includes/db/' . $dbms . '.' . $phpEx);
	require($phpbb_root_path . 'includes/constants.' . $phpEx);
	require($phpbb_root_path . 'includes/functions.' . $phpEx);

	$db = new $sql_db();
	$cache = new cache_phpbb();
